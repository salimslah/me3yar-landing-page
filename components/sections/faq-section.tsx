...
const faqs: FaqItem[] = [
  {
    question: 'ما هي منصة معيار (Me3yar) وكيف تعمل؟',
  ...
  {
    question: 'هل يمكننا دمج بياناتنا من الأنظمة الأخرى مثل Excel أو Slack؟',
    answer: 'نعم، تدعم معيار مرونة عالية للتكاملات البرمجية. يمكنك رفع وتحديث بياناتك مباشرة عبر ملفات Excel، أو استخدام أدوات الربط والتكامل المدمجة مع Slack وNotion والأنظمة المخصصة عبر الـ API للتحديث الفوري التلقائي للمؤشرات.'
  },
  {
